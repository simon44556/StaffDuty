...
public class PrefixManager {
    ...
    public String getPrefixesLuck(User user, QueryOptions queryOptions){
        ...
        MetaStackElement primary = luckPerms.getMetaStackFactory().fromString(LUCKPERMS_SORT_ORDER + configHandler.getPrimaryTrack()).orElse(null);
        MetaStackElement secondary = luckPerms.getMetaStackFactory().fromString(LUCKPERMS_SORT_ORDER + configHandler.getSecondaryTrack()).orElse(null);
